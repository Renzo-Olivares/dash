...
class _DatePickerHeader extends StatelessWidget {
  ...
  final DatePickerModeCustom mode;
  final ValueChanged<DatePickerModeCustom> onModeChanged;
  final Orientation orientation;

  void _handleChangeMode(DatePickerModeCustom value) {
  ...
  Widget build(BuildContext context) {
    ...
    switch (themeData.primaryColorBrightness) {
      case Brightness.light:
        dayColor =
            mode == DatePickerModeCustom.day ? Colors.black87 : Colors.black54;
        yearColor =
            mode == DatePickerModeCustom.year ? Colors.black87 : Colors.black54;
        break;
      case Brightness.dark:
        dayColor =
            mode == DatePickerModeCustom.day ? Colors.white : Colors.white70;
        yearColor =
            mode == DatePickerModeCustom.year ? Colors.white : Colors.white70;
        break;
    }
    ...
    final Widget yearButton = IgnorePointer(
      ignoring: mode != DatePickerModeCustom.day,
      ignoringSemantics: false,
      child: _DateHeaderButton(
        color: backgroundColor,
        onTap: Feedback.wrapForTap(
            () => _handleChangeMode(DatePickerModeCustom.year), context),
        child: Semantics(
          selected: mode == DatePickerModeCustom.year,
    ...
    final Widget dayButton = IgnorePointer(
      ...
      child: _DateHeaderButton(
        color: backgroundColor,
        onTap: Feedback.wrapForTap(
            () => _handleChangeMode(DatePickerModeCustom.day), context),
        child: Semantics(
          selected: mode == DatePickerModeCustom.day,
...
class DatePickerDialog extends StatefulWidget {
  ...
  final DateTime lastDate;
  final SelectableDayPredicate selectableDayPredicate;
  final DatePickerModeCustom initialDatePickerMode;
...
class _DatePickerDialogState extends State<DatePickerDialog> {
  ...
  void _handleModeChanged(DatePickerModeCustom mode) {
    _vibrate();
    setState(() {
      _mode = mode;
      if (_mode == DatePickerModeCustom.day) {
        SemanticsService.announce(
  ...
  void _handleYearChanged(DateTime value) {
    ...
    _vibrate();
    setState(() {
      _mode = DatePickerModeCustom.day;
      _selectedDate = value;
    });
  }
  ...
  Widget _buildPicker() {
    ...
    switch (_mode) {
      ...
      case DatePickerModeCustom.year:
        return YearPicker(
          key: _pickerKey,
          selectedDate: _selectedDate,
  ...
  Widget build(BuildContext context) {
    ...
    final SizedBox dialog = SizedBox(
        width: 400,
        height: 300,
...
///
/// An optional [initialDatePickerModeCustom] argument can be used to display the
...
Future<DateTime> showDatePicker({
  ...
  DatePickerModeCustom initialDatePickerMode = DatePickerModeCustom.day,
  Locale locale,
  TextDirection textDirection,
